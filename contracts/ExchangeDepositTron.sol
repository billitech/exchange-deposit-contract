...
contract ExchangeDeposit {
     ...
     */
    uint256 public minimumInput = 10000000; // 0.01 TRX;
    /**
    ...
    /**
     * @dev Internal function for getting the sendTo address for gathering TRC20/ETH.
     * If the contract is dead, they will be forwarded to the adminAddress.
     * @return address payable for sending TRC20/ETH
     */
     ...
     * @param instance The address of the trc20 token contract
     */
    function gatherTrc20(IERC20 instance) external {
